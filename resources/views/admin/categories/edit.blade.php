...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Cập nhật Danh mục</h1>
        <p class="text-sm text-gray-500 mt-1">Chỉnh sửa thông tin cho danh mục hiện tại.</p>
    </div>
    <div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" value="Laptop Gaming" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Đường dẫn tĩnh (Slug)</label>
                    <input type="text" value="laptop-gaming" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-gray-50">
                ...
                <div>
                    ...
                    <textarea rows="3" class="w-full border border-gray-300 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">Danh mục chứa các dòng laptop chuyên phục vụ cho việc chơi game, cấu hình cao.</textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" value="fas fa-gamepad" class="w-full border border-gray-300 rounded-lg py-2 pl-10 pr-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
                </div>
